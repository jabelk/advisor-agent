...
OCCUPATIONS = [
    "Software Engineer", "Physician", "Attorney", "Business Owner", "Professor",
    "Dentist", "Pharmacist", "Architect", "Financial Analyst", "Marketing Director",
    "Sales Executive", "Real Estate Developer", "Consultant", "Nurse Practitioner",
    "Veterinarian", "Civil Engineer", "IT Director", "Operations Manager",
    "Portfolio Manager", "Pilot", "Surgeon", "Executive Vice President",
    "Chief Technology Officer", "Regional Manager", "Senior Partner",
    "Retired Military", "Retired Teacher", "Small Business Owner",
    "Investment Banker", "Corporate Counsel",
]

INVESTMENT_GOALS_BY_RISK = {
    "conservative": [
        "Capital preservation", "Stable income", "Wealth protection",
        "Fixed income focus", "Low-volatility portfolio",
    ],
    "moderate": [
        "Balanced growth and income", "College fund savings",
        "Retirement planning", "Diversified portfolio", "Steady wealth building",
    ],
    "growth": [
        "Long-term capital appreciation", "Technology sector growth",
        "Aggressive growth with diversification", "Maximize total returns",
        "Growth-oriented ETF portfolio",
    ],
    "aggressive": [
        "Maximum growth", "Concentrated sector bets", "Options trading",
        "High-risk high-reward", "Startup and venture investments",
    ],
}
